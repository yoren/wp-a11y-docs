...
function initSearch() {
  ...
  request.open('GET', '/wp-a11y-docs/pr-preview/pr-2/assets/js/search-data.json', true);
  ...
  codeBlocks.forEach(codeBlock => {
    ...
    copyButton.addEventListener('click', function () {
      if(timeout === null) {
        ...
        copyButton.ariaLabel = 'Code is copied to clipboard';
